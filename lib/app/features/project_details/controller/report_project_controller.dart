...
class ReportProjectController extends GetxController{
  ...
  addReportProject(context,{FileModel? file,String? idProject}) async {
    ...
    String id= '${XFile(file?.name??"").name??""}000000'.substring(0,6)+'${Timestamp.now().microsecondsSinceEpoch}';
      if(file!=null){
