...
class HelperWeatherScreen extends StatelessWidget {
  const HelperWeatherScreen({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    final model = context.watch<WeatherScreenModel>();

    return   model.forecastObject?.location?.name != null && model.loading == false
        ? _ViewWidget()
        : Center(
